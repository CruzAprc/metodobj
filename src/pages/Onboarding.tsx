...
const OnboardingOtimizado = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="px-6 pb-6 max-w-md mx-auto">
        ...
        delay: 0.4
      }} className="relative mb-6 sm:mb-8 mx-2">
          <div className="relative bg-gradient-to-br from-pink-400 to-pink-600 rounded-2xl sm:rounded-3xl p-0.5 shadow-2xl">
            <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-white relative overflow-hidden">
              ...
              <div className="text-center space-y-3 sm:space-y-4">
                <h3 className="text-lg sm:text-xl font-bold leading-tight">Metodologia App da Juju</h3>
                <p className="text-pink-100 text-sm leading-relaxed max-w-xs mx-auto">
                ...
                scale: 0.95
              }} className="w-14 h-14 sm:w-16 sm:h-16 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto shadow-lg border border-white/30">
                  {isVideoPlaying ? <Pause size={20} className="text-white sm:w-6 sm:h-6" /> : <Play size={20} className="text-white ml-0.5 sm:w-6 sm:h-6" />}
                </motion.button>
                
                <div className="flex items-center justify-center space-x-3 sm:space-x-4 text-xs text-pink-100">
                  <span className="flex items-center space-x-1">
                    <Clock size={10} className="sm:w-3 sm:h-3" />
                    <span className="text-xs">3:45 min</span>
                  </span>
                  <span>•</span>
