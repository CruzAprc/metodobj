    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-pink-50 to-purple-50 overflow-hidden">
      ...
      >
        <div className="flex items-center space-x-3">
          <div className="w-12 h-12 bg-gradient-to-br from-blue-300 to-blue-400 rounded-2xl flex items-center justify-center shadow-lg p-1">
            <img 
      ...
      <div className="px-4 pb-6 max-w-lg mx-auto">
        ...
        >
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-3 leading-tight">
            Bem-vinda ao <span className="bg-gradient-to-r from-blue-400 to-pink-500 bg-clip-text text-transparent">App da Juju!</span>
          </h2>
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed max-w-sm mx-auto">
            Sua jornada de <span className="font-semibold text-blue-500">transformação</span> e <span className="font-semibold text-pink-600">performance</span> começa aqui!
          </p>
        </motion.div>
        ...
        >
          <div className="relative bg-gradient-to-br from-blue-300 to-pink-400 rounded-3xl p-0.5 shadow-2xl">
            <div className="bg-gradient-to-br from-blue-400 via-blue-500 to-pink-500 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden min-h-[280px] sm:min-h-[320px]">
              ...
              <div className="text-center space-y-5 sm:space-y-6 flex flex-col justify-center h-full">
                <div>
                  ...
                  <p className="text-blue-100 text-base sm:text-lg leading-relaxed max-w-sm mx-auto">
                ...
                >
                  {isVideoPlaying ? (
                    ...
                    <Play size={28} className="text-white ml-1 sm:w-8 sm:h-8" />
                  )}
                </motion.button>
                
                <div className="flex items-center justify-center space-x-4 sm:space-x-5 text-sm text-blue-100">
        ...
        >
          {[
            ...
            <motion.div 
              ...
              className={`flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-gradient-to-r ${benefit.color} border shadow-sm hover:shadow-md transition-all duration-300`}
            >
              <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-white/70 rounded-xl flex items-center justify-center shadow-sm">
                {benefit.icon}
              </div>
        ...
        >
          ...
          <div className="relative h-20 sm:h-24 overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-50 via-pink-50 to-purple-50 border-2 border-blue-200/50 shadow-sm">
            <AnimatePresence mode="wait">
              ...
              >
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-400 to-pink-400 rounded-full flex items-center justify-center text-sm sm:text-lg flex-shrink-0 shadow-sm">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs bg-gradient-to-r from-blue-100 to-blue-200 text-blue-700 px-2 py-0.5 rounded-full whitespace-nowrap ml-2 font-medium">
              ...
              <div 
                ...
                className={`h-1.5 rounded-full transition-all duration-300 ${
                  index === currentTestimonial 
                    ? 'bg-gradient-to-r from-blue-400 to-pink-400 w-4 sm:w-6' 
                    : 'bg-gray-300 w-1.5'
                }`} 
              />
            ))}
        ...
        >
          <motion.button 
            ...
            whileTap={{ scale: 0.98 }} 
            className="w-full bg-gradient-to-r from-blue-400 via-blue-500 to-pink-500 hover:from-blue-500 hover:via-blue-600 hover:to-pink-600 text-white font-bold py-4 sm:py-5 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 transition-all duration-300 text-sm sm:text-base"
          >
          ...
          <div className="text-center px-4">
            <p className="text-sm sm:text-base text-gray-500">
              ⏱️ Apenas <span className="font-semibold text-blue-500">5 minutos</span> para personalizar tudo para você!
            </p>
          </div>
        </motion.div>
